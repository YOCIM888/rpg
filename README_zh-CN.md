...
└── docs/
    ...
    ├── 剧情解析.md          # 剧情深度解析
    ├── 数据维护指南.md      # 数据驱动维护文档
    ├── General-Game-Guide.md      # English: Full game guide
    ├── Story-Route-Guide.md       # English: Story route guide
    ├── All-Endings-Speedrun.md    # English: All endings speedrun
    ├── Story-Analysis.md          # English: Story analysis
    └── Data-Maintenance-Guide.md  # English: Data maintenance guide
```
...
| [剧情解析](剧情解析.md) | 剧情深度解析、角色分析、世界观解读 |
| [数据维护指南](数据维护指南.md) | 如何通过修改数据文件维护游戏数据 |
| [后续更新参考](../About-inspiration-and-Update-Reference/后续更新参考.md) | DLC方向、续作建议、技术债务清单 |
| [General-Game-Guide](General-Game-Guide.md) | English: Full game guide |
| [Story-Route-Guide](Story-Route-Guide.md) | English: Story route guide |
| [All-Endings-Speedrun](All-Endings-Speedrun.md) | English: All endings speedrun |
| [Story-Analysis](Story-Analysis.md) | English: Deep story analysis |
| [Data-Maintenance-Guide](Data-Maintenance-Guide.md) | English: Data maintenance guide |
| [Future-Update-Reference](../About-inspiration-and-Update-Reference/Future-Update-Reference.md) | English: Future update reference |
