...
import { handleSavePage, returnToMenu } from './game.js';
...
<div class="panel inventory-panel">
  ...
  <div class="stat-row"><span class="stat-label">【货物】</span><span class="stat-value">${state.cargo.map(c => c.name).join('、') || '无'}</span></div>
</div>`;
}
