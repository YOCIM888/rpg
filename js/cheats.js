...
import { FOODS, DRINKS, MEDICINES, FRUITS, CIGARETTES, AMMO, MELEE_WEAPONS, RANGED_WEAPONS, LOOT_BACKPACKS } from './config.js';
...
const MELEE_NAMES = ['平底锅', '大扳手', '小匕首', '屠刀', '铁管', '警棍', '指虎刀', '棒球棍', '撬棍', '羊角锤', '大砍刀', '消防斧', '武士刀', '电锯'];
const RANGED_NAMES = ['G17', 'P226', 'GP100', 'UZI', 'MP5', 'MP7', 'M16A4', 'M4A1', 'HK416', 'AK47', 'M700', 'AWM', 'M870', 'AA12'];
