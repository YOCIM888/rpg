...
const INITIAL_STATE = {
  ...
  other: [],
  cargo: [],
  npcAffinity: { v: 0, xiaohan: 0, lili: 0 },
  npcQuestsDone: { v1: false, v2: false, v3: false, v4: false, xh1: false, xh2: false, llGift: false },
  lastBegDay: 0,
  npcChatCount: { v: 0, xiaohan: 0, lili: 0 },
  lastChatDay: 0,
...
export function advanceTime(steps = 1) {
  ...
  while (gameState.crashTurns >= 24) {
    gameState.crashTurns -= 24;
    gameState.crash = clamp(gameState.crash + 20, 0, 100);
...
export function addNpcAffinity(npcId, amount) {
  ...
  return gameState.npcAffinity[npcId];
}
...
export function resetChatCounts() {
  ...
  gameState.npcChatCount = { v: 0, xiaohan: 0, lili: 0 };
}
...
export function normalizeState(state) {
  ...
  if (state.npcChatCount === undefined) {
    state.npcChatCount = { v: 0, xiaohan: 0, lili: 0 };
  }
