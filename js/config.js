...
export const BACKPACK_TYPES = {
  ...
  战术背包: { id: "战术背包", name: "战术背包", type: "战术背包", capacity: 42 },
...
export const MAPS = [
  ...
  { id: "绝密航天基地", name: "绝密航天基地", danger: "★★★★★★炼狱", encounterRate: 0.9,
    lootTable: { ranged: 25, ammo: 30, melee: 10, medicine: 15, food: 5, drink: 5, backpack: 5, empty: 5 } },
];
...
export const BASE_LEVELS = [
  ...
  { name: "幸存者木屋", bonus: 5, cost: { wood: 15, building_mat: 5 } },
  { name: "幸存者石屋", bonus: 10, cost: { wood: 25, building_mat: 10, stone: 10 } },
  { name: "幸存者房子", bonus: 15, cost: { wood: 40, building_mat: 20, stone: 20, nails: 10 } },
  { name: "幸存者别墅", bonus: 20, cost: { wood: 60, building_mat: 35, stone: 35, nails: 25, glass: 10 } },
];
...
export function pickRandomLoot(map) {
  ...
  switch (type) {
    ...
    case "melee": {
      ...
      const melee = weightedRandom(MELEE_WEAPONS.filter(w => w.id !== DEFAULT_ITEM_IDS.melee), w => rarityWeights[w.rarity] || 1);
