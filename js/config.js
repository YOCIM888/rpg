...
export const ZOMBIES = [
  { id: "普通游荡丧尸", name: "普通游荡丧尸", hp: 120, damage: 16, dodge: 0.05, ability: null },
  { id: "腐烂腐尸", name: "腐烂腐尸", hp: 100, damage: 24, dodge: 0, ability: "infect" },
  { id: "疾行丧尸", name: "疾行丧尸", hp: 80, damage: 30, dodge: 0.35, ability: null },
  { id: "肥胖臃肿尸", name: "肥胖臃肿尸", hp: 240, damage: 20, dodge: 0, ability: null },
  { id: "军警丧尸", name: "军警丧尸", hp: 160, damage: 36, dodge: 0.1, ability: null },
  { id: "群居尸母", name: "群居尸母", hp: 140, damage: 16, dodge: 0, ability: "summon" },
  { id: "撕裂狂暴尸", name: "撕裂狂暴尸", hp: 200, damage: 50, dodge: 0.05, ability: null },
  { id: "酸液喷射尸", name: "酸液喷射尸", hp: 240, damage: 28, dodge: 0.05, ability: "acid" },
  { id: "巨型坦克尸", name: "巨型坦克尸", hp: 300, damage: 40, dodge: 0, ability: null },
...
export const SURVIVOR_NPC = [
  {
    ...
    quests: {
      ...
      v3: { name: "血清任务", desc: "上交8个抗感染血清", reqAffection: 60, require: { medicine: 8, medicineId: "抗感染血清" }, reward: { item: "电锯", desc: "电锯×1" }, story: "\"血清是末世最珍贵的资源之一。\" 她递给你一把电锯。\"你值得用这个了。\"" },
  ...
  },
  {
    ...
    quests: {
      ...
      xh4: { name: "罐头收集", desc: "提交所有罐头各1个", reqAffection: 90, require: { allCanned: 1 }, reward: { itemStack: [{ id: "抗感染血清", count: 3 }], desc: "抗感染血清×3" }, story: "\"哇，这么多罐头！\" 小涵开心地把罐头分类放好。\"这些够阵地的大家吃好几天了！这些血清是我之前存下来的，给你！\"" },
      xh5: { name: "水果派对", desc: "提交所有水果各1个", reqAffection: 120, require: { allFruits: 1 }, reward: { itemStack: [{ id: "医用急救包", count: 3 }], desc: "医用急救包×3" }, story: "\"天哪！水果！\" 小涵的眼睛亮了起来。\"好久没吃过新鲜水果了！我要给大家做水果拼盘！这几个急救包你收好！\"" },
      xh6: { name: "大采购", desc: "提交所有饮品各1个+所有食物各1个", reqAffection: 150, require: { allDrinks: 1, allFoods: 1 }, reward: { itemStack: [{ id: "战地医疗箱", count: 3 }], desc: "战地医疗箱×3" }, story: "\"这、这太多了吧！\" 小涵感动得眼眶泛红。\"你把整个超市都搬来了吗？我……我都不知道该怎么谢你！这几个战地医疗箱你一定要收下！\"" }
    }
  },
  {
    id: "lili",
...
export const DOCTOR_INTRO = "一个戴着厚重眼镜的中年男人坐在研究所的废墟中，手里拿着一管发光的血清。他抬起头推了推眼镜：\"又一个幸存者……我对你没有恶意，但如果你能帮我个忙的话……\"";
...
export const ZOMBIE_KING_INTRO = "巢穴深处，一个巨大的身影缓缓站起。它的体型是普通丧尸的三倍，皮肤如同黑色的盔甲，猩红的眼睛死死盯着你。它的身上插满了各种武器残骸，似乎在诉说它战胜过无数挑战者。这就是丧尸巢穴真正的主人——沉默的丧尸之王。它没有咆哮，但那种压迫感让你的心脏几乎停止跳动。";
...
export const NURSE_ZOMBIE_INTRO = "一个穿着破烂护士服的女性丧尸蜷缩在角落里，她的眼睛竟然还保留着一丝人类的理智。她盯着你手中的食物，喉咙里发出微弱的呜咽声。";
