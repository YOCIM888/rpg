...
export const FOODS = [
  ...
  { id: "面包", name: "面包", type: "food", hunger: 20 },
  { id: "肉罐头", name: "肉罐头", type: "food", hunger: 40 },
  { id: "水果罐头", name: "水果罐头", type: "food", hunger: 25 },
  { id: "巧克力棒", name: "巧克力棒", type: "food", hunger: 15 },
  { id: "牛肉干", name: "牛肉干", type: "food", hunger: 20 },
  { id: "八宝粥", name: "八宝粥", type: "food", hunger: 35 },
  { id: "干脆面", name: "干脆面", type: "food", hunger: 10 }, 
  { id: "军粮口粮", name: "军粮口粮", type: "food", hunger: 50 },
  { id: "沙丁鱼罐头", name: "沙丁鱼罐头", type: "food", hunger: 25 },
  { id: "面包干", name: "面包干", type: "food", hunger: 15 },
];

export const DRINKS = [
  { id: "矿泉水", name: "矿泉水", type: "drink", hydration: 30, effects: null },
  { id: "能量饮料", name: "能量饮料", type: "drink", hydration: 35, effects: null },
  { id: "可口可乐", name: "可口可乐", type: "drink", hydration: 20, effects: null },
  { id: "瓶装橙汁", name: "瓶装橙汁", type: "drink", hydration: 25, effects: null },
  { id: "苹果汁", name: "苹果汁", type: "drink", hydration: 25, effects: null },
  { id: "椰汁", name: "椰汁", type: "drink", hydration: 30, effects: null },
  { id: "电解质饮料", name: "电解质饮料", type: "drink", hydration: 40, effects: null },
  { id: "威士忌", name: "威士忌", type: "drink", hydration: 15, effects: { crash: -10 } },
  { id: "纯净水", name: "纯净水", type: "drink", hydration: 35, effects: null },
  { id: "运动饮料", name: "运动饮料", type: "drink", hydration: 30, effects: null },
  { id: "热可可", name: "热可可", type: "drink", hydration: 25, effects: { crash: -5 } },
];
...
export const TRADE_TEMPLATES = [
  { foodNeeded: 2, ammoType: "9×19mm", ammoCount: 10, desc: "2份食物换10发9×19mm子弹" },
  { foodNeeded: 3, ammoType: ".357 Magnum弹", ammoCount: 10, desc: "3份食物换10发.357 Magnum弹" },
  { foodNeeded: 1, ammoType: "9×19mm", ammoCount: 5, desc: "1份食物换5发9×19mm子弹" },
  { foodNeeded: 4, ammoType: ".357 Magnum弹", ammoCount: 15, desc: "4份食物换15发.357 Magnum弹" },
];
...
export const MAPS = [
  {
    ...
    danger: "★★★中危",
    encounterRate: 0.4,
    lootTable: { food: 40, drink: 35, melee: 10, empty: 15 },
  },
  {
    id: "城郊大型医院",
    name: "城郊大型医院",
    danger: "★★★★高危",
    encounterRate: 0.6,
    lootTable: { medicine: 60, ammo: 10, empty: 30 },
  },
  {
    id: "国道高速服务区",
    name: "国道高速服务区",
  ...
  },
  {
    ...
    danger: "★★★中危",
    encounterRate: 0.35,
    lootTable: { food: 25, drink: 20, melee: 15, medicine: 5, backpack: 5, empty: 35 },
  },
  {
    id: "废弃警察局",
    name: "废弃警察局",
    danger: "★★★★高危",
    encounterRate: 0.55,
    lootTable: { melee: 20, ranged: 5, ammo: 25, medicine: 5, backpack: 3, empty: 45 },
  },
  {
    id: "深山农家乐村落",
    name: "深山农家乐村落",
    danger: "★安全~★★低危",
    encounterRate: 0.1,
    lootTable: { food: 40, drink: 20, empty: 40 },
  },
  {
    id: "工业园区/加工厂",
    name: "工业园区/加工厂",
    danger: "★★★中危",
    encounterRate: 0.35,
    lootTable: { melee: 30, food: 15, drink: 10, backpack: 5, empty: 45 },
  },
  {
    id: "地下地铁隧道",
    name: "地下地铁隧道",
    danger: "★★★★★绝境",
    encounterRate: 0.8,
    lootTable: { ammo: 15, ranged: 5, empty: 80 },
  },
  {
    id: "高校大学城",
    name: "高校大学城",
    danger: "★★低危",
    encounterRate: 0.2,
    lootTable: { food: 35, drink: 30, empty: 35 },
  },
  {
    id: "江边港口码头",
    name: "江边港口码头",
  ...
  },
  {
    ...
    danger: "★★★中危",
    encounterRate: 0.35,
    lootTable: { food: 40, drink: 35, medicine: 5, backpack: 3, empty: 20 },
  },
  {
    id: "山顶废弃瞭望塔",
    name: "山顶废弃瞭望塔",
    danger: "★安全",
    encounterRate: 0.05,
    lootTable: { empty: 85, ammo: 5, food: 5, drink:5, backpack: 5 },
  },
  {
    id: "乡村废弃谷仓",
    name: "乡村废弃谷仓",
    danger: "★安全",
    encounterRate: 0.08,
    lootTable: { food: 43, drink: 42, melee: 10, empty: 5 },
  },
  {
    id: "河边露营地",
    name: "河边露营地",
    danger: "★安全~★★低危",
    encounterRate: 0.15,
    lootTable: { food: 35, drink: 35, melee: 5, medicine: 5, empty: 20 },
  },
  {
    id: "郊区废弃加油站",
    name: "郊区废弃加油站",
