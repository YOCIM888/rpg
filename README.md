...
└── docs/
    ...
    ├── 剧情解析.md          # Story analysis (Chinese)
    ├── 数据维护指南.md      # Data maintenance guide (Chinese)
    ├── General-Game-Guide.md      # Full game guide (English)
    ├── Story-Route-Guide.md       # Story route guide (English)
    ├── All-Endings-Speedrun.md    # All endings speedrun guide (English)
    ├── Story-Analysis.md          # Story analysis (English)
    └── Data-Maintenance-Guide.md  # Data maintenance guide (English)
```
...
|:---------|:------------|
| [General-Game-Guide](docs/General-Game-Guide.md) | Full game guide (English) |
| [Story-Route-Guide](docs/Story-Route-Guide.md) | Story route guide (English) |
| [All-Endings-Speedrun](docs/All-Endings-Speedrun.md) | All endings speedrun guide (English) |
| [Story-Analysis](docs/Story-Analysis.md) | Deep story analysis (English) |
| [Data-Maintenance-Guide](docs/Data-Maintenance-Guide.md) | Data-driven maintenance guide (English) |
| [Future-Update-Reference](About-inspiration-and-Update-Reference/Future-Update-Reference.md) | DLC directions, sequel ideas, tech debt (English) |
...
| [剧情解析](docs/剧情解析.md) | Deep story analysis (Chinese) |
| [数据维护指南](docs/数据维护指南.md) | Data maintenance guide (Chinese) |
| [后续更新参考](About-inspiration-and-Update-Reference/后续更新参考.md) | DLC directions, sequel ideas, tech debt (Chinese) |
